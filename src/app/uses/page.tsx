    ...
    <MainLayout>
      ...
      <main>
        <section className="mb-8">
          ...
          <ul className="space-y-4 leading-relaxed">11
        ...
        <section>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <strong>Email:</strong> I use {linker({ linktext: "proton mail", href: "https://proton.me/mail" })}  for now, but I think I should just self host an email server. I also have gmail though, can't just get rid of it sadly.
            </li>

            <li>
              <strong>Messaging:</strong> I use almost all texting apps but the ones I use the most are {linker({ linktext: "telegram", href: "https://telegram.org/" })}  and discord. I think Telegram is the best messaging app out there, it has a lot of features and great UI.
            </li>

            <li>
              <strong>Music: </strong> {linker({ linktext: "Spotify", href: "https://www.spotify.com/" })}. I have a habit of always playing something while I'm working, that's why a centralised platform with a large music repository works for me. Otherwise I'd have stored all my music locally.
            </li>
          </ul>
        </section>
      </main>
